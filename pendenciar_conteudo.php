...
<h1>Consulta de Conteúdo - Pendenciar Conteúdo</h1>
            ...
            <div>
                <table class='tabela'>
                    ...
                    <tr>
                        ...
                        $sql = "update conhecimento set sts_conhecimento = 'P' where id_conhecimento = '$id_conhecimento'";
                        $query = mysqli_query($bcon, $sql);

                        if (mysqli_query($bcon, $sql) === TRUE) {
                            echo "<script>"
                            . "alert('Registro Pendenciado com Sucesso!');"
                            . "history.go(-1);"
                            . "</script> ";
                            exit;
                        } else {
